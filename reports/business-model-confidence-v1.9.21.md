...
> [!IMPORTANT]
> This version has been superseded by [v1.9.22](file:///Users/rifaterdemsahin/projects/AI-Certification-Customer-Development/reports/business-model-confidence-v1.9.22.md).
> See [the updated report on live page](http://localhost:8000/markdown_renderer.html?src=reports/business-model-confidence-v1.9.22.md).

**Date:** 2026-08-14  
**Produced by:** the `business-model-sanity-check` skill (`.claude/skills/business-model-sanity-check/SKILL.md`)  
**What changed vs. v1.9.20:** patch re-run, no new check categories. Incorporated Perplexity market-feedback sanity check (`reports/raise-validation-perplexity-v1.0.0.md`) validating the R.A.I.S.E. framing and founder origin story, and refined H1's conclusion to reflect that certifications are complementary to, not substitutes for, demonstrable skills and act as filters/screens. Updated H1's Source list, Conclusion, and Status, and updated `5_Symbols/strategy/raise.html` with a Market Validation and Nuance section.
...
| 7 | Uncommitted work (`git status --porcelain`) | −10 | Same open batch of changes. This run adds `reports/raise-validation-perplexity-v1.0.0.md` + edits to `raise.html`, `hyp-h1.html`, `hypothesis.html`, `evidence-map.html`, `latest-pages.html`, and `nav.js`. Does not stack a second −10. Clears once committed. |

...
| **4. Unsolicited Referral & Authentic Delight (H5 / H20 / H22)** | *"...sonra sizi anlattım onlara, öğrendiğim her şeyi o hocam sayesinde öğrendim diye🤭🙆🏻‍♀️"* <br><br> *"...Then I told them all about you, saying 'I learned everything I know thanks to my teacher!' 🤭🙆🏻‍♀️"* | Pure organic word-of-mouth referral into academic and enterprise research circles without paid ad spend ($0 CAC). |
...
```mermaid
flowchart TD
    subgraph MultiUser ["Multi-User Knowledge Ingestion Challenge"]
        U1["User A: Professor<br>(Abstract / Research Context)"] --> V["Shared Unpartitioned Obsidian Vault"]
        U2["User B: PhD Student<br>(Implementation / Experimental Context)"] --> V
        U3["User C: Intern / Practitioner<br>(Tooling / Workflow Context)"] --> V
    end

    subgraph Problem ["Ontology Collision & Semantic Drift"]
        V --> F["Ambiguous Terminology & Polysemy<br>'Smallest building block of words differs per person'"]
        F --> G["Agent Context Confusion & Hallucination<br>(Prompt Drift & Loss of Precision)"]
    end

    subgraph Solution ["Delivery Pilot Recommended Architecture"]
        G --> H["Isolated Personal Sub-Vaults / Namespaces"]
        H --> I["Federated Semantic RAG / Knowledge Graph Router"]
        I --> J["Agentic Verification & Schema Validation (H30)"]
    end

    classDef danger fill:#ef4444,stroke:#b91c1c,color:#fff;
    classDef arch fill:#6366f1,stroke:#4f46e5,color:#fff;

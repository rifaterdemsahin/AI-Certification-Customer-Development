...
(function () {
    ...
    var groups = [
        ...
        },
        {
            type: 'dropdown', label: 'Docs', emoji: '📄', className: 'nav-docs', items: [
                ...
                ['markdown_renderer.html?src=reports/customer-discovery-bayo-interview-v1.0.0.md', '👤 Bayo CD Interview v1.0'],
    ...
    var searchIndex = [
        { url: 'markdown_renderer.html?src=reports/customer-discovery-bayo-interview-v1.0.0.md', title: 'Customer Discovery Report: Bayo Interview', desc: 'Qualitative analysis of Bayo interview on burnout, work struggle, voluntary redundancy / exit, commitment to Anthropic qualification, and async video catch-up.', cat: 'Docs', tags: 'bayo customer discovery interview burnout voluntary redundancy exit anthropic qualification claude architect live cohort attendance friction async video replays cognitive overload stress work situation fde contractor h24 h29 h1 h5 h8 h25 h30 report' },

...
(function () {
    ...
    var groups = [
        ...
        },
        {
            type: 'dropdown', label: 'Docs', emoji: '📄', className: 'nav-docs', items: [
                ...
                ['markdown_renderer.html?src=reports/customer-discovery-burak-interview-v1.0.0.md', '✋ Burak WhatsApp Farewell CD v1.0'],
                ['markdown_renderer.html?src=reports/customer-discovery-b2b-insurance-training-v1.0.0.md', '🏢 B2B Insurance AI Training CD v1.0'],
                ['markdown_renderer.html?src=reports/customer-discovery-community-recommendations-fun-v1.0.0.md', '💬 Community Recs &amp; Fun over Lecture CD v1.0'],
                ...
                ['markdown_renderer.html?src=reports/customer-discovery-faruk-interview-v1.0.0.md', '👤 Faruk CD Interview v1.0 (CEO Ops)'],
                ['markdown_renderer.html?src=reports/customer-discovery-charles-interview-v1.2.0.md', '👤 Charles CD Interview v1.2 (Cowork)'],
                ['markdown_renderer.html?src=reports/customer-discovery-charles-interview-v1.1.0.md', '👤 Charles CD Interview v1.1 (MCP)'],
                ['markdown_renderer.html?src=reports/customer-discovery-charles-interview-v1.0.0.md', '👤 Charles CD Interview v1.0 (Historical)'],
    ...
    var searchIndex = [
        ...
        { url: 'markdown_renderer.html?src=3_Simulation/Interviews/interview_charles_2026-08-30.md', title: 'Discovery Record: Charles Claude Cowork Daily Status (2026-08-30)', desc: 'Raw record: We need Claude CoWork for the daily status report, logged while Charles learned certification course content.', cat: 'Docs', tags: 'interview charles claude cowork daily status report 2026-08-30 raw record' },
        ...
        { url: 'markdown_renderer.html?src=3_Simulation/Interviews/interview_charles_2026-08-29.md', title: 'Discovery Record: Charles WhatsApp MCP (2026-08-29)', desc: 'Raw WhatsApp thread: MCP server, lots of competitors, I did not pay them, associate exam has no MCP term.', cat: 'Docs', tags: 'interview charles whatsapp mcp competitors common language 2026-08-29 raw record' },

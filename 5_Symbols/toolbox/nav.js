    ...
    var groups = [
        ...
        },
        {
            type: 'dropdown', label: 'Docs', emoji: '📄', className: 'nav-docs', items: [
                ...
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-brian-interview-v1.1.0.md', '👤 Brian CD Interview v1.1'],

...
(function () {
    ...
    var groups = [
        { type: 'link', href: 'index.html', label: 'Hub', emoji: '🏠', className: 'nav-hub' },
        {
            type: 'dropdown', label: 'Favorites', emoji: '⭐', className: 'nav-favorites', items: [
                ...
                ['5_Symbols/growth/hands-on-obs-course-section.html', '📹 Hands-on OBS Course Section', '2026-09-17'],
                ...
                ['5_Symbols/cd/top-3-priority-hypotheses.html', '🎯 Top 3 Priority Hypotheses (Sep 2026)', '2026-09-10'],
        ...
        {
            type: 'dropdown', label: 'Discovery', emoji: '🔍', className: 'nav-discovery', items: [
                { header: '🗺️ Stages Overview' },
                ...
                ['5_Symbols/cd/enterprise-openshift-onboarding.html', '🏢 Enterprise OpenShift Onboarding &amp; Engine'],
                ...
                ['5_Symbols/cd/chidi-strategy-session-feedback.html', '♟️ Chidi: Strategy, CFO &amp; Lean CTO Agents'],
                ['5_Symbols/cd/onur-developer-burnout-ai-slop.html', '⚡ Onur: Developer Burnout &amp; AI Slop'],
                ...
                ['5_Symbols/cd/top-3-priority-hypotheses.html', '🎯 Top 3 Priority Hypotheses (Sep 2026)'],
                { header: '🧪 Hypothesis Framework (1–4)' },
        ...
        },
        {
            type: 'dropdown', label: 'Strategy', emoji: '🎯', className: 'nav-strategy', items: [
                { header: '🎯 Core Strategy & Positioning' },
                ['5_Symbols/strategy/b2c2b-business-model.html', '🏢 B2C2B Business Model &amp; Sourcing'],
                ['5_Symbols/strategy/b2c2b-sourcing-vs-bulk-sessions.html', '⚖️ B2C2B: Sourcing vs. Bulk 1-1s'],
                ...
                { header: '⚠️ Planning, Risk & Hypotheses' },
                ...
                ['5_Symbols/product/exam-topics.html', '📚 Exam Topic Blueprint'],
                ...
                { header: '📖 Founder Reading & Frameworks' },
        ...
        },
        {
            type: 'dropdown', label: 'Business Model', emoji: '📊', className: 'nav-business', items: [
                { header: '🖼️ Business Model Canvas' },
                ...
                ['5_Symbols/product/community-timeline-roadmap.html', '🧭 Community Timeline &amp; Roadmap'],
                { header: '🏫 Skool Community Setup' },
                ...
                { header: '💰 Skool Growth & Monetization' },
                ...
                { header: '⚖️ Skool Moderation & Rules' },
                ...
                { header: '🪜 Skool Onboarding & Levels' },
        ...
        },
        {
            type: 'dropdown', label: 'Growth', emoji: '📈', className: 'nav-growth', items: [
                ...
                { header: '🗓️ Roadmaps & Planning' },
                ['5_Symbols/growth/event-management-leadgen-crm.html', '🎯 Event Planning, LinkedIn Virality &amp; CRM'],
                ...
                ['5_Symbols/growth/hands-on-obs-course-section.html', '📹 Hands-on OBS Course Section'],
                ...
                { header: '📢 Community Promotion & Comms' },
                ...
                ['5_Symbols/growth/linkedin-saturday-invites.html', '💼 Saturday LinkedIn Cohort Invites'],
                { header: '🌱 Retention & Community Growth' },
        ...
        },
        {
            type: 'dropdown', label: 'Docs', emoji: '📄', className: 'nav-docs', items: [
                { header: '📄 Core Docs' },
                ['5_Symbols/toolbox/markdown_renderer.html?src=README.md', '📖 README'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=gemini.md', '🧠 Project Rationale'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=agents.md', '🤖 AI Agent Guidelines'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=4_Formula/HYPOTHESIS.md', '📊 Hypothesis Tracker Full Doc'],
                ...
                ['5_Symbols/strategy/business-overview.html', '📝 Business Overview (One-Pager)'],
                { header: '📊 Market & Business Reports' },
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/eos-traction-alignment-v1.0.0.md', '📘 EOS Traction Alignment Report v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/acidity-check-report-v1.4.0.md', '🧪 Acidity Check Report v1.4'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/acidity-check-report-v1.3.0.md', '🧪 Acidity Check Report v1.3 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/acidity-check-report-v1.2.0.md', '🧪 Acidity Check Report v1.2 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/acidity-check-report-v1.1.0.md', '🧪 Acidity Check Report v1.1 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/acidity-check-report-v1.0.md', '🧪 Acidity Check Report v1.0 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/market-validation-argument-v1.0.md', '🏛️ Market Validation Argument'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/ai-adoption-and-skills-gap-v1.0.md', '📈 AI Adoption &amp; Skills Gap'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.7.0.md', '📊 Exam Prep Market v1.7'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.6.0.md', '📊 Exam Prep Market v1.6 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.5.0.md', '📊 Exam Prep Market v1.5 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.4.0.md', '📊 Exam Prep Market v1.4 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.3.0.md', '📊 Exam Prep Market v1.3 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.2.0.md', '📊 Exam Prep Market v1.2 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.1.0.md', '📊 Exam Prep Market v1.1 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.0.md', '📊 Exam Prep Market v1.0 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-pricing-feedback-v1.2.0.md', '💎 Skool Pricing Feedback v1.2'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-pricing-feedback-v1.1.0.md', '💎 Skool Pricing Feedback v1.1 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-pricing-feedback-v1.0.0.md', '💎 Skool Pricing Feedback v1.0 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-founder-posting-sanity-check-v1.0.md', '📝 Skool Posting Sanity Check'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-workshop-upload-sanity-check-v1.0.md', '🎬 Workshop Upload Sanity Check'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/raise-validation-perplexity-v1.0.0.md', '🔍 Perplexity RAISE Validation'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/chatgpt-narrative-and-investor-feedback-v1.0.0.md', '🤖 ChatGPT Investor Feedback v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-pricing-feedback-v1.0.0.md', '💬 Skool Pricing Feedback v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-availability-v1.0.0.md', '📡 Skool Availability v1.0'],
                { header: '👤 Customer Discovery Interview Reports' },
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-chidi-strategy-session-v1.0.0.md', '♟️ Chidi: Strategy &amp; Governance CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-onur-developer-burnout-ai-slop-v1.0.0.md', '⚡ Onur: Developer Burnout &amp; AI Slop CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-mehmet-halil-course-video-v1.1.0.md', '🎧 Mehmet &amp; Halil First Course Video CD v1.1'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-mehmet-halil-course-video-v1.0.0.md', '🎧 Mehmet &amp; Halil First Course Video CD v1.0 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.3.0.md', '🔁 Charles 4th Exam &amp; Udemy Benefit CD v1.3'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-marianna-event-planning-crm-v1.0.0.md', '🎯 Marianna Event Planning &amp; CRM CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-bora-interview-v1.0.0.md', '🎯 Bora Monthly Career Call CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-burak-interview-v1.0.0.md', '✋ Burak WhatsApp Farewell CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-b2b-insurance-training-v1.0.0.md', '🏢 B2B Insurance AI Training CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-community-recommendations-fun-v1.0.0.md', '💬 Community Recs &amp; Fun over Lecture CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-ilker-marianna-b2c2b-v1.0.0.md', '👤 Ilker &amp; Marianna B2C2B CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-ai-common-language-library-short-v1.0.0.md', '📚 AI Common Language Library Short v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-private-quiz-lead-magnet-v1.0.0.md', '🕵️ Private Quiz Tactic Report v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-enterprise-openshift-onboarding-v1.0.0.md', '🏢 Enterprise OpenShift Onboarding CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-1-1-v1.0.0.md', '👤 Sude First 1-1 CD Report v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-interview-v1.2.0.md', '👤 Sude CD Interview v1.2 (Multi-Skilled FDE)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-unal-interview-v1.1.0.md', '👤 Sude CD Feedback v1.1 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-unal-interview-v1.0.0.md', '👤 Sude CD Interview v1.0 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-marianna-pedagogy-first-principles-v1.0.0.md', '👤 Marianna Pedagogy &amp; First Principles CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-marianna-voice-roger-rabbit-v1.0.0.md', '👤 Marianna Voice + Roger Rabbit CD v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-cheuk-ho-interview-v1.0.0.md', '👤 Cheuk Ho CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-mehmet-interview-v1.0.0.md', '👤 Mehmet CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-jamal-interview-v1.0.0.md', '👤 Jamal CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-b-interview-v1.0.0.md', '👤 B. CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-hcl-devops-interview-v1.0.0.md', '🎙️ HCL DevOps Screen CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-faruk-interview-v1.0.0.md', '👤 Faruk CD Interview v1.0 (CEO Ops)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.2.0.md', '👤 Charles CD Interview v1.2 (Cowork)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.1.0.md', '👤 Charles CD Interview v1.1 (MCP)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.0.0.md', '👤 Charles CD Interview v1.0 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-anna-interview-v1.0.0.md', '👤 Anna CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-marianna-interview-v1.0.0.md', '👤 Marianna CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-brian-interview-v1.2.0.md', '👤 Brian CD Interview v1.2'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-brian-interview-v1.1.0.md', '👤 Brian CD Interview v1.1 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-brian-interview-v1.0.0.md', '👤 Brian CD Interview v1.0 (Historical)'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-tomiwa-interview-v1.1.0.md', '👤 Tomiwa CD Interview v1.1'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-rakesh-interview-v1.0.0.md', '👤 Rakesh CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-apo-interview-v1.0.0.md', '👤 Apo CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-baran-g-interview-v1.0.0.md', '👤 Baran G CD Interview v1.0'],
                ['5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/cohort-session-8-analysis-v1.0.0.md', '🎙️ Cohort Session 8 Deep Dive v1.0']
            ]
        }
    ];
    ...
    var searchIndex = [
        { url: '5_Symbols/cd/chidi-strategy-session-feedback.html', title: '♟️ Chidi: Strategy, Multi-Agent Governance & Role Constraints', desc: '1-on-1 strategy sync: automate LinkedIn manual feed browsing via AI agents, enforce financial discipline (3,000 watch hours toward monetization), sandbox & validate "the receipts" internally, and institute synthetic Strict CFO & Lean CTO personas.', cat: 'Discovery', tags: 'chidi customer discovery interview strategy multi-agent governance strict cfo lean cto devils advocate role constraints linkedin research agent linkedin writer agent 3000 watch hours monetization sandbox receipts 24 associate shorts h2 h10 h24 h29 h30 h35' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-chidi-strategy-session-v1.0.0.md', title: 'Customer Discovery Report: Chidi — Multi-Agent Governance & Role Constraints v1.0', desc: 'Detailed report on Chidi strategic pushback: single-founder bandwidth overload, automating manual research, strict financial targets (3k watch hours), and pre-release internal sandbox validation.', cat: 'Docs', tags: 'chidi customer discovery report v1.0 strategy multi-agent governance cfo cto role constraints watch hours monetization sandbox h2 h10 h24 h29 h30 h35 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_chidi_2026-09-20_strategy_cfo_cto_agents.md', title: 'Discovery Record: Chidi — Strategy & Advisory Review (2026-09-20)', desc: 'Raw intake: 1-hour cohort architecture, LinkedIn 40k views reverse response marketing, AI feed automation, synthetic CFO and Lean CTO personas, and strict confidentiality mandate.', cat: 'Docs', tags: 'interview chidi raw record 2026-09-20 transcript strategy cfo cto multi-agent governance watch hours h2 h10 h24 h29 h30 h35' },
        { url: '5_Symbols/cd/onur-developer-burnout-ai-slop.html', title: '⚡ Onur: Developer Burnout, Idle AI Guilt & The "AI Slop" Filter Chain', desc: 'American Turkish tech YouTuber & 14-yr US consultant: AI acceleration paradox, 10x workload pressure, white hair/burnout, guilt over idle compute, context switching amnesia, and rejecting multi-stage AI slop.', cat: 'Discovery', tags: 'onur customer discovery interview tech youtube developer burnout ai slop acceleration paradox idle compute guilt god doesnt like idle hands context switching claude code recap enterprise architecture cursor spa forward deployed engineer h1 h2 h24 h25 h28 h30 h31 h35' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-onur-developer-burnout-ai-slop-v1.0.0.md', title: 'Customer Discovery Report: Onur — Developer Burnout & AI Slop v1.0', desc: 'Detailed report on Onur developer vent: acceleration paradox, multi-agent context switching, semantic distortion across AI communication chains, toy SPAs vs enterprise realities, and 95% throwaway demos vs H35 repo ladder.', cat: 'Docs', tags: 'onur customer discovery report v1.0 developer burnout ai slop context switching enterprise architecture forward deployed engineer h1 h2 h24 h25 h28 h30 h31 h35 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_onur_2026-09-17_developer_burnout_ai_slop.md', title: 'Discovery Record: Onur — Developer Burnout & AI Slop (2026-09-17)', desc: 'Raw intake: 14+ years US software consultant/engineer, full verbatim English translated transcript of YouTube video essay, and detailed thematic breakdown.', cat: 'Docs', tags: 'interview onur raw record 2026-09-17 transcript developer burnout ai slop claude code cursor h1 h2 h24 h25 h28 h30 h31 h35' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-maggie-cohort-v1.0.0.md', title: 'Customer Discovery Report: Sude & Maggie Cohort — AI Hype vs Reality v1.0', desc: 'Sude dismisses AI-doom marketing, reaffirms cert-as-competence-proof, and validates prompt frameworks. New joiner Maggie is an FDE-persona lead corroborating repo-based IP protection.', cat: 'Docs', tags: 'sude maggie customer discovery cohort session interview ai hype doom larry ellison second brain prompt engineering role context task constraints forward deployed engineer ip ownership h1 h2 h24 h29 h30 h31 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_sude_maggie_2026-09-13.md', title: 'Discovery Record: Sude & Maggie Cohort Session (2026-09-13)', desc: 'Raw intake: AI doom vs reality, Second Brain personalization, prompt engineering framework validation, Maggie AI adoption consultancy FDE lead, and spec-driven IP protection.', cat: 'Docs', tags: 'interview sude maggie cohort session raw record 2026-09-13 h1 h2 h24 h29 h30 h31' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-firat-interview-v1.0.0.md', title: 'Customer Discovery Report: Firat Mobile Founder Pragmatism & Anti-Paranoia v1.0', desc: 'Android app founder discovery: prediction skepticism, pushback against "saving humanity" savior complex, early Android platform parallels, and Lisbon Web Summit Sam Altman challenge.', cat: 'Docs', tags: 'firat customer discovery interview android app founder startup web summit lisbon sam altman savior complex prediction skepticism ip privacy paranoia human ingenuity h1 h24 h28 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_firat_2026-09-12.md', title: 'Discovery Record: Firat Mobile Founder & Web Summit Sync (2026-09-12)', desc: 'Raw intake: Android business owner, prediction skepticism, teases afterlife savior complex, early mobile privacy comparison, displacement empathy, Web Summit pitch challenge.', cat: 'Docs', tags: 'interview firat android founder web summit lisbon startup sam altman prediction skepticism raw record 2026-09-12 h1 h24 h28 h29 h30' },
        ...
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-marianna-event-planning-crm-v1.0.0.md', title: 'Customer Discovery Report: Marianna Event Planning & Lead Gen CRM v1.0', desc: 'Marianna customer discovery feedback: bi-weekly planning cadence, 8-part class curriculum blueprint, LinkedIn Events viral popularization, Meetup/Eventbrite syndication, and Event CRM pipeline.', cat: 'Docs', tags: 'marianna customer discovery report event planning linkedin events meetup eventbrite lead generation crm 8 part class blueprint 14 day runway h4 h5 h12 h23 h28 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_marianna_2026-09-07_event_planning_crm.md', title: 'Discovery Record: Marianna Event Planning & CRM (2026-09-07)', desc: 'Raw intake from Marianna post-career call feedback: real event planning, bi-weekly cadence, LinkedIn Event viral invitations, Meetup/Eventbrite publishing, event CRM function.', cat: 'Docs', tags: 'interview marianna event planning crm linkedin events meetup eventbrite 2026-09-07 raw record h4 h5 h12 h23 h28 h29 h30' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.3.0.md', title: 'Customer Discovery Report: Charles Interview v1.3 — 4th Exam, Corporate Sponsorship & Udemy Practice-Paper Benefit', desc: 'Charles\'s sanitized customer story on his 4th Capgemini-sponsored certification exam (135-minute proctored professional-level architecture assessment) plus a WhatsApp follow-up naming a Capgemini-Udemy practice-paper benefit.', cat: 'Docs', tags: 'charles customer discovery interview 4th exam capgemini corporate sponsorship back to back certification udemy practice papers architect professional 135 minute proctored testing facility h1 h8 h12 h25 h27 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_charles_2026-09-09.md', title: 'Discovery Record: Charles 4th Exam & Udemy Benefit (2026-09-09)', desc: 'Raw intake: sanitized customer story on Capgemini-sponsored 4th certification exam, plus WhatsApp follow-up on the Capgemini-Udemy practice-paper partnership.', cat: 'Docs', tags: 'interview charles 4th exam capgemini sponsorship udemy practice papers raw record 2026-09-09 h1 h8 h12 h25 h27 h30' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-bora-interview-v1.0.0.md', title: 'Customer Discovery Report: Bora Monthly Career Promotion Call v1.0', desc: 'Monthly VIP promotion call: Open Interpreter/Groq job application triage, escaping DevOps "Red Ocean", GCP Architect certs & 10-member enterprise partner tier requirements.', cat: 'Docs', tags: 'bora customer discovery interview career promotion monthly vip call open interpreter groq vps job application automation red ocean devops linux admin cloud solution architect gcp architect baris partner tier 10 certified staff ir35 tax trading bots debiasing h1 h5 h8 h24 h25 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_bora_2026-09-07.md', title: 'Discovery Record: Bora Monthly Career Call (2026-09-07)', desc: 'Raw intake from Bora monthly career promotion call: Open Interpreter automation, stealth LinkedIn profile, GCP Architect exam, partner program thresholds, 15 AI trading bot tests.', cat: 'Docs', tags: 'interview bora monthly career promotion call open interpreter groq devops red ocean gcp architect baris partner tier raw record 2026-09-07 h1 h5 h8 h24 h25 h29 h30' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-burak-interview-v1.0.0.md', title: 'Customer Discovery Report: Burak WhatsApp Farewell v1.0', desc: 'Unprompted WhatsApp cohort exit message: training value confirmed ("white coding since then"), but new role at work ends cohort participation. Career-success capacity constraint.', cat: 'Docs', tags: 'burak customer discovery interview whatsapp group farewell new role at work career success attrition white coding applied value h5 h8 h24 h29 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_burak_2026-09-07.md', title: 'Discovery Record: Burak WhatsApp Farewell (2026-09-07)', desc: 'Raw intake from Burak WhatsApp group exit message: white coding, new role at work, appreciative departure.', cat: 'Docs', tags: 'interview burak whatsapp farewell new role white coding raw record 2026-09-07 h5 h8 h24 h29' },
        ...
        { url: '5_Symbols/strategy/b2c2b-sourcing-vs-bulk-sessions.html', title: 'B2C2B Models: Talent Sourcing vs. Bulk 1-1 Sessions', desc: 'Comprehensive comparison of the two enterprise B2C2B models: Talent Sourcing Marketplace (badges, skill gaps, FDE staffing) vs. Enterprise Bulk 1-1 Sessions (Business Owner strategic advisory vs. Team hands-on coaching), detailing trade-offs, pros, cons, and founder bandwidth.', cat: 'Strategy', tags: 'b2c2b talent sourcing bulk 1-1 sessions business owner team coaching delivery pilot badges skills gap pros cons comparison fde staffing advisory h1 h5 h8 h9 h12 h22 h24 h25 h29 h30' },
        ...
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-community-recommendations-fun-v1.0.0.md', title: 'Customer Discovery Report: Collaborative Growth & Fun over Monologue Lecture v1.0', desc: 'Customer discovery qualitative feedback on peer recommendation loops, collaborative growth, intrinsic motivation vs obligation, and fun party format over monologue lecturing.', cat: 'Docs', tags: 'community qualitative feedback peer recommendations collaborative growth intrinsic motivation obligation fun party format lecture h5 h8 h20 h29 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-ilker-marianna-b2c2b-v1.0.0.md', title: 'Customer Discovery Report: Ilker & Marianna B2C2B, Positive Skills & Custom Apps v1.0', desc: 'Customer discovery synthesis of Ilker & Marianna advisory session: B2C2B progressive 2B rollout via SMEs to enterprise sourcing, positive AI skills messaging, and dual-engine community value.', cat: 'Docs', tags: 'ilker marianna customer discovery interview b2c2b sme enterprise talent sourcing positive message rapid ai skills custom apps second brain dual engine report h1 h5 h8 h12 h22 h24 h25 h29 h30' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_ilker_marianna_b2c2b_2026-08-28.md', title: 'Discovery Record: Ilker & Marianna Strategy Session (2026-08-28)', desc: 'Raw interview intake notes from Ilker & Marianna meeting covering B2C2B business model, SME-to-enterprise talent sourcing, positive AI skills narrative, and community custom app value.', cat: 'Docs', tags: 'interview ilker marianna b2c2b positive message custom apps discovery raw record 2026-08-28 h1 h12 h22 h24 h25 h30' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-interview-v1.2.0.md', title: 'Customer Discovery Report: Sude Multi-Skilled FDE & Portfolio v1.2', desc: 'Sude customer discovery feedback: becoming a multi-skilled developer through AI video creation, building agentic AI infrastructure, and public product portfolios.', cat: 'Docs', tags: 'sude customer discovery interview multi skilled developer agentic ai infrastructure portfolio real products fde forward deployed engineer ai video creation milestone roadmap h1 h2 h8 h10 h25 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_sude_2026-09-01.md', title: 'Discovery Record: Sude Multi-Skilled Developer & Portfolio (2026-09-01)', desc: 'Raw discovery notes: becoming a multi-skilled developer, building agentic systems & AI infrastructure, and building a portfolio of real products.', cat: 'Docs', tags: 'interview sude multi skilled developer agentic ai infrastructure portfolio real products 2026-09-01 raw record h1 h2 h8 h10 h25 h29 h30' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-unal-interview-v1.1.0.md', title: 'Customer Discovery Report: Sude Academic Lab Visit & Multi-User Ontology (Historical v1.1)', desc: 'Sude customer discovery feedback: instructing university faculty/PhDs on Obsidian Second Brains, diagnosing multi-user ontology collision / semantic drift risks, and organic founder advocacy.', cat: 'Docs', tags: 'sude customer discovery interview academic lab university professor phd students second brain obsidian multi-user shared second brain ontology collision semantic drift agent concepts founder attribution delight maot h5 h8 h12 h20 h22 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_sude_unal_2026-08-31.md', title: 'Discovery Record: Sude Academic Lab Visit (2026-08-31)', desc: 'Raw feedback and discovery notes from Sude explaining Second Brains & AI agents to university faculty and analyzing multi-user knowledge integration limits.', cat: 'Docs', tags: 'interview sude academic lab second brain obsidian multi user ontology collision raw feedback 2026-08-31 h5 h8 h20 h30' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-sude-unal-interview-v1.0.0.md', title: 'Customer Discovery Report: Sude Interview (Historical v1.0)', desc: 'Qualitative analysis of Sude discovery feedback on weekday cohort demand, Obsidian Second Brain hybrid RAG, multi-stage parallelization workflows, and environment inspection.', cat: 'Docs', tags: 'sude customer discovery interview weekday cohort live calls second brain obsidian rag hybrid search dense sparse bm25 parallelization workflow environment inspection verification post action h4 h5 h8 h10 h24 h29 h30 report' },
        ...
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/chatgpt-narrative-and-investor-feedback-v1.0.0.md', title: 'ChatGPT Narrative & Investor Readiness Feedback Report v1.0.0', desc: 'Detailed report evaluating business model narrative, 4 core cards, TAM/SAM/SOM market sizing rigor, defensible secret insight, and cohort value stack.', cat: 'Docs', tags: 'chatgpt narrative investor readiness feedback report 4 core cards secret insight visual ai education value stack research and markets pearson vue gov uk h1 h2 h3 h5 h6 h8 h12 h21 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-marianna-voice-roger-rabbit-v1.0.0.md', title: 'Customer Discovery Report: Marianna Voice Clone + Roger Rabbit / Dalinea Signature', desc: 'Qualitative analysis of Marianna feedback to pair founder AI voice clone with dalinea Roger Rabbit mixed-reality animation for audience memorability, shipping fal.ai ElevenLabs studio.', cat: 'Docs', tags: 'marianna customer discovery interview dalinea roger rabbit founder ai voice clone fal.ai elevenlabs eleven-v3 memorable audience h2 h10 h17 h28 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-cheuk-ho-interview-v1.0.0.md', title: 'Customer Discovery Report: Cheuk Ho Interview', desc: 'Qualitative analysis of Cheuk Ho interview on AI-generated post fatigue, audience engagement friction, and written founder voice mandate.', cat: 'Docs', tags: 'cheuk cheuk ho customer discovery interview ai generated posts fatigue engagement friction founder voice authentic voice linkedin national grid h2 h4 h5 h10 h24 h28 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-mehmet-interview-v1.0.0.md', title: 'Customer Discovery Report: Mehmet Interview', desc: 'Qualitative analysis of Mehmet interview on "1k Short vs. 3dk Course", creator watering holes (Erhan Meydan, Suna & Akın), reverse response marketing, and £1,000 corporate vs D2C membership pricing.', cat: 'Docs', tags: 'mehmet customer discovery interview shorts reels micro format 1k short 3dk course erhan meydan suna akin reverse response marketing corporate 1000 pound d2c membership founder schedule time discipline h2 h3 h5 h10 h12 h21 h24 h28 h29 h30 report' },
        ...
        { url: '5_Symbols/growth/course-curriculum-learning-objectives.html', title: 'AI Course Curriculum & 5-Minute Video Learning Objectives (LOs & KRs)', desc: 'Modular 5-minute video blueprints pairing Learning Objectives (LOs) with Key Results (KRs) across Certified Associate, Developer, and Certified Architect tracks, including Claude Cowork daily status (Charles) and ops must-haves for juniors (Faruk).', cat: 'Growth', tags: 'course curriculum 5-minute video learning objectives key results okrs certified associate foundations developer track certified architect foundations claude architect professional claude cowork daily status report charles faruk operations must-haves video 3.4 content locator flywheel h1 h2 h4 h5 h8 h10 h12 h29 h30' },
        { url: '5_Symbols/growth/hands-on-obs-course-section.html', title: 'Hands-on Session Course Section (Daily OBS Screen Recordings)', desc: 'Daily OBS Studio screen-recorded practitioner course section across Beginner, Intermediate, and Advanced skill tiers, providing 24/7 on-demand access to real-time coding, terminal execution, and enterprise architectures.', cat: 'Growth', tags: 'hands on obs course section daily recording beginner intermediate advanced screencasts terminal docker claude code cli mcp rag hitl multi agent enterprise architecture skool classroom h5 h8 h29 h34' },
        ...
        { url: '5_Symbols/strategy/being-useful-for-the-other.html', title: 'How to Be Genuinely Useful for the Audience (6 Pillars & Pre-Creation Scorecard)', desc: 'Master blueprint on genuine audience utility: making learners feel smart, dual-engine value, Gary Stevenson raw passion, 60-min turnkey presets, high-touch empathy, and the 6-question litmus scorecard.', cat: 'Strategy', tags: 'how to be genuinely useful for the audience being useful for the other 6 pillars value creation litmus scorecard make them feel smart dual engine gary stevenson 1-1 presets delivery menu customer development h24 h25 h29 h30 h33 h5' },
        ...
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-hcl-devops-interview-v1.0.0.md', title: 'Customer Discovery Report: HCL DevOps Screen Interview', desc: 'Qualitative analysis of HCL SRE/DevOps technical screen on "Pre-AI Era" enterprise constraints, hands-on cluster proof vs cert badges, and dual-track contractor model.', cat: 'Docs', tags: 'hcl devops screen customer discovery interview pre-ai era manual execution gke backstage terraform vault jenkins hands-on cluster mastery dual-track contractor founder bandwidth h1 h24 h25 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/founder-voice-skool-cta-v1.0.0.md', title: 'Founder Voice vs AI Voice v1.0.0', desc: 'Two independent viewers of AI Isn\'t a Bubble accepted the content and rejected an automated voice when selling Skool.', cat: 'Docs', tags: 'founder voice automated voice skool youtube 27jXA2V2Zio h2 h5 h29' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-faruk-interview-v1.0.0.md', title: 'Customer Discovery Report: Faruk Interview v1.0 (CEO Marketing AI vs Ops Juniors)', desc: '2026-08-30: CEO Faruk says AI is mostly used in marketing; operations is not; hired ops juniors miss must-haves; he does not see the AI-ops-junior connect; bored with non-value-driven AI.', cat: 'Docs', tags: 'faruk ceo customer discovery interview marketing ai operations juniors must-haves business demand non-value-driven video 3.4 h1 h8 h12 h24 h25 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_faruk_2026-08-30.md', title: 'Discovery Record: Faruk CEO Marketing vs Ops Juniors (2026-08-30)', desc: 'Raw record: AI mostly in marketing; ops juniors miss must-haves; no AI-ops-junior connect; bored with non-value-driven AI applications.', cat: 'Docs', tags: 'interview faruk ceo marketing operations juniors must-haves 2026-08-30 raw record' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.2.0.md', title: 'Customer Discovery Report: Charles Interview v1.2 (Claude Cowork Daily Status)', desc: '2026-08-30: while learning cert course content, Charles said we need Claude Cowork for the daily status report. Anthropic product lab, not Monday VIP recruiter session.', cat: 'Docs', tags: 'charles andrews customer discovery interview claude cowork daily status report certification course content associate video 2.4 h1 h8 h25 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_charles_2026-08-30.md', title: 'Discovery Record: Charles Claude Cowork Daily Status (2026-08-30)', desc: 'Raw record: We need Claude CoWork for the daily status report, logged while Charles learned certification course content.', cat: 'Docs', tags: 'interview charles claude cowork daily status report 2026-08-30 raw record' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.1.0.md', title: 'Customer Discovery Report: Charles Interview v1.1 (MCP Common Language)', desc: 'WhatsApp 2026-08-29: Charles finally knows what an MCP server is; lots of competitors; did not pay them; Associate exam omits MCP; common language matters.', cat: 'Docs', tags: 'charles andrews customer discovery interview mcp model context protocol common language competitors unpaid associate exam glossary h1 h3 h25 h29 h32 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=3_Simulation/Interviews/interview_charles_2026-08-29.md', title: 'Discovery Record: Charles WhatsApp MCP (2026-08-29)', desc: 'Raw WhatsApp thread: MCP server, lots of competitors, I did not pay them, associate exam has no MCP term.', cat: 'Docs', tags: 'interview charles whatsapp mcp competitors common language 2026-08-29 raw record' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-charles-interview-v1.0.0.md', title: 'Customer Discovery Report: Charles Interview v1.0 (Historical)', desc: 'Qualitative analysis of Charles interview on "Cooking Steak: Low and Slow" learning philosophy, non-urgent AI needs for personal projects, and market bifurcation.', cat: 'Docs', tags: 'charles customer discovery interview cooking steak low and slow personal projects time pressure capgemini consultant learner psychology artisanal craft fun h24 h29 h1 h3 h8 h25 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-anna-interview-v1.0.0.md', title: 'Customer Discovery Report: Anna Interview', desc: 'Qualitative analysis of Anna interview on 5-10-5 pacing methodology (5m demo, 10m execute, 5m Q&A), 3-task session duration caps (40–60 min), and cognitive overload guardrails.', cat: 'Docs', tags: 'anna customer discovery interview uwise cambridge professor ukrainian founder 5-10-5 methodology pacing duration cognitive overload fatigue sunday live cohort h29 h8 h2 h10 h5 h17 h24 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-marianna-interview-v1.0.0.md', title: 'Customer Discovery Report: Marianna Interview', desc: 'Qualitative analysis of Marianna customer interview on Sunday AI Brain collaborative labs, practical workshops programme co-creation, and flipped classroom pre-session short AI video primers.', cat: 'Docs', tags: 'marianna customer discovery interview maria testing lead compliance ai brain sunday practical workshops programme flipped classroom short ai videos tool primers installation dependencies h17 h2 h10 h30 h8 h29 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-brian-interview-v1.2.0.md', title: 'Customer Discovery Report: Brian Interview v1.2', desc: 'Qualitative analysis of Brian customer discovery interview on delegation-over-DIY buyer mode ("get a mortgage and delegate") and the core message needing to give hope and possibility.', cat: 'Docs', tags: 'brian customer discovery interview delegation diy mortgage delegate hope possibility messaging house build service learning h1 h24 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-brian-interview-v1.1.0.md', title: 'Customer Discovery Report: Brian Interview v1.1 (Historical)', desc: 'Qualitative analysis of Brian customer discovery interview on India and US timezone 1-1 coordination, study slot scarcity as forcing function, and failure-triggered course enrollment.', cat: 'Docs', tags: 'brian customer discovery interview timezone india usa timezone coordination 1-1 slots scarcity study timeline failure triggered post failure exam score rescue retake h5 h8 h24 h25 h29 h30 h1 h3 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-brian-interview-v1.0.0.md', title: 'Customer Discovery Report: Brian Interview (Historical)', desc: 'Qualitative analysis of Brian customer interview on skills paying bills, complex Kubernetes / CI-CD depth, reducing disposability, and client guide demand.', cat: 'Docs', tags: 'brian customer discovery interview skills pay bills kubernetes cicd disposability client guide rules fde contractor h30 h1 h25 h24 h12 h29 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-tomiwa-interview-v1.1.0.md', title: 'Customer Discovery Report: Tomiwa Interview v1.1', desc: 'Qualitative analysis of Tomiwa interview on clearing Claude Associate in 2 days, 1-month prep for Architect in September, skipping Developer, contractor upskilling ROI, 5-person AI team compression, and 2-year obsolescence window.', cat: 'Docs', tags: 'tomiwa customer discovery interview claude associate claude architect certification ladder bifurcation hands on contractor roi workforce shift fde 5 person team 2 year window h25 h1 h8 h21 h24 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-rakesh-interview-v1.0.0.md', title: 'Customer Discovery Report: Rakesh Interview', desc: 'Qualitative analysis of Rakesh interview on rising UK Employer National Insurance, permanent employment overhead inflation, and accelerating contractor / FDE demand.', cat: 'Docs', tags: 'rakesh customer discovery interview national insurance employment overhead taxes contractors fde ir35 h30 h12 h24 h1 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-apo-interview-v1.0.0.md', title: 'Customer Discovery Report: Apo Interview', desc: 'Qualitative analysis of Apo customer interview on business revenue uplift over paper credentials, Amazon FBA automation with Claude, and eliminating 100-tab noise.', cat: 'Docs', tags: 'apo customer discovery interview amazon fba e-commerce business revenue automation 100 tabs noise signal h1 h25 h29 h30 report' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/customer-discovery-baran-g-interview-v1.0.0.md', title: 'Customer Discovery Report: Baran G Interview', desc: 'Qualitative analysis of Baran G customer interview on tabular AI agent automation, Excel data processing, time scarcity, and presentation outputs.', cat: 'Docs', tags: 'baran g customer discovery interview tabular excel agents time pressure emotional drivers h24 h17 h30 report' },
        ...
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/cohort-session-10-analysis-v1.0.0.md', title: 'Cohort Session 10 Analysis Report v1.0.0', desc: 'Versioned markdown report of Session 10: 5x shorts retention, ~30 Skool joins, Chidi Uber-license money path, Mariana simplicity and Chamber networking.', cat: 'Docs', tags: 'cohort session 10 report chidi mariana b2b payroll simplicity shorts h12 h22 h30' },
        ...
        { url: '5_Symbols/growth/animation-shorts-pipeline.html', title: 'Animation Shorts Pipeline & Tools', desc: 'Measured 2.5h studio SOP: per-video GitHub repo, Jules + Pages, Gemini, Google Flow, Canva, ElevenLabs, YouTube Studio. Current workspace aug-video-animation-6-core-message.', cat: 'Growth', tags: 'animation shorts pipeline tools timelines jules github pages google flow canva elevenlabs youtube studio aug-video-animation-6 core message h2 h4 h10 h28 h29' },
        ...
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-pricing-feedback-v1.0.0.md', title: 'Skool Pricing Feedback v1.0.0', desc: 'Founder-confirmed Freemium entitlements graded: keep $0 / $1 / $250, rename Standard / Premium / VIP, cap VIP 1:1.', cat: 'Docs', tags: 'skool pricing feedback freemium standard premium vip peek sit share h5' },
        ...
        { url: '5_Symbols/product/community-timeline-roadmap.html', title: 'Community Timeline & Roadmap — From Cert Seeker to Vetted Delivery Pilot', desc: 'Detailed community timeline mapping both the rapid certification graduate exit and the elite Delivery Pilot secret society accession into deliverypilot.net backend.', cat: 'Business Model', tags: 'community timeline roadmap certification exit delivery pilot secret society backend memory cards mock exams tenders contract rate h5 h8 h20 h30' },
        ...
        { url: '5_Symbols/growth/linkedin-saturday-invites.html', title: 'Saturday LinkedIn Cohort Invitations (8 Weeks)', desc: 'Copy-ready Saturday LinkedIn invitations for the next 8 Sunday 13:30–14:30 UK labs (5 Sep–24 Oct 2026), each with unique copy and a unique visual. Dated headers, never Today.', cat: 'Growth', tags: 'linkedin saturday invitations cohort sunday 1330 uk swipe file copy paste visuals september october 2026 h5 h4 h29 skool live' },
        ...
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/skool-availability-v1.0.0.md', title: 'Skool Availability v1.0.0', desc: 'First logged-out run: PASS 11/11 gates, Public, 11 members, 14 posts, Sude non-founder thread visible.', cat: 'Docs', tags: 'skool availability report public members posts h5' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.8.0.md', title: 'Exam Prep & Student Behavior v1.8.0', desc: 'Cheuk (National Grid) cannot self-enroll in Claude certifications; only enterprise partners have access; two partner companies enroll people.', cat: 'Docs', tags: 'cheuk national grid enrollment block partner gated f12 h1 h12 exam access' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.7.0.md', title: 'Exam Prep & Student Behavior v1.7.0', desc: 'Adds Bora Session 8 follow-up discovery: session stacking cognitive fatigue, vacation/noise constraints, boat cruise, and mid-week async course binge study.', cat: 'Docs', tags: 'bora customer discovery session 8 fatigue stacked sessions vacation boat cruise async binge study exam prep h5 h8 h20 h26 h29' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/acidity-check-report-v1.4.0.md', title: 'Acidity Check Report v1.4.0', desc: 'F12 moves to partially addressed: Cheuk could not self-enroll; two partner companies mitigate by seating candidates.', cat: 'Docs', tags: 'acidity f12 cheuk partner enrollment partially addressed' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.6.0.md', title: 'Exam Prep & Student Behavior v1.6.0', desc: 'Adds Mehmet: immigrant vetting is weak, old talent checks fail, proctored certs rise in institutional and government MSP hires.', cat: 'Docs', tags: 'mehmet immigrant vetting msp government proctored certification institutional h1 h12 h25' },
        { url: '5_Symbols/toolbox/markdown_renderer.html?src=7_Testing_Known/reports/score-fluctuation-analysis-v1.0.0.md', title: 'Score Fluctuation Analysis v1.0.0', desc: 'Detailed explanation of why the confidence score fluctuates (up to 46, down to 43) due to Git commit status (uncommitted work deductions).', cat: 'Docs', tags: 'score fluctuation analysis confidence report git commit status uncommitted work' },
        ...
        { url: '5_Symbols/strategy/motivation.html', title: 'Motivation: Why & How This Makes Money', desc: 'Full-site synthesis of why the business exists, the three revenue streams, and the ICP personas tied to each one.', cat: 'Strategy', tags: 'motivation money revenue icp personas why founder' },
        ...
        { url: '5_Symbols/dashboard/confidence-report.html', title: 'Business Model Confidence Report', desc: 'Versioned, whole-site sanity check scoring hypothesis validation and site integrity into one confidence number. v1.9.95 holds 49 after Bora & Marianna CD ingestion and Event Management CRM spec.', cat: 'Docs', tags: 'confidence score sanity check audit integrity version bora marianna event management crm v1.9.95' },
        ...
        { url: '5_Symbols/product/exam-topics.html', title: 'Exam Topic Blueprint', desc: 'Full official topic list for the Associate (19 topics, real mastery data) and Architect (30 topics) exams, grouped for curriculum sequencing.', cat: 'Strategy', tags: 'exam topics blueprint curriculum associate architect foundations professional domains' },
        ...
        { url: '5_Symbols/strategy/business-overview.html', title: 'Business Overview (One-Pager)', desc: 'Plain-language one-page reference for what the business does, who it is for, how it makes money, and current stage.', cat: 'References', tags: 'business overview one pager elevator pitch summary reference what does this do' },
        ...
        { url: '5_Symbols/cd/top-3-priority-hypotheses.html', title: 'Top 3 Priority Hypotheses (Sep 2026)', desc: 'The 3 foundational hypotheses (H3, H5, H27) to deliberately test face-to-face throughout September 2026, with why-ranked rationale, live status, and a September conversation log.', cat: 'Process', tags: 'top 3 priority hypotheses september 2026 face to face interview h3 h5 h27' },
        ...
        { url: '5_Symbols/growth/inspirational-youtubers.html', title: 'Inspirational YouTubers & Creator Benchmarks', desc: 'Detailed strategic deconstruction of Gary Stevenson (raw passion & relentless message focus), Simplilearn (YouTube Courses tab & introductory paths), Ali Abdaal, NetworkChuck, and TechWorld with Nana.', cat: 'Growth', tags: 'inspirational youtubers creator benchmarks gary stevenson garyseconomics passion raw conviction relentless message simplilearn youtube courses ali abdaal networkchuck tech with nana shorts animation video workflow devops h2 h10 h13 h24 h28 h30' },
        ...
        groups.forEach(function (group) {
            ...
            if (group.type === 'link') {
                ...
                dropdownItems.forEach(function (item) {
                    if (!item.header && isActive(item[0])) {
                        hasActiveChild = true;
                    }
                });
    ...
    var tourNarration = {
        ...
        '5_Symbols/strategy/motivation.html': { title: 'Founder Motivation & ICP', desc: 'The strategic \'why\' of the project. Understand Rifat\'s personal rules, target personas, revenue streams, and exit gates.', emoji: '🔥' },
    ...
    function buildTourStops() {
        ...
        searchIndex.forEach(function(item) {
            if (item.url.indexOf('5_Symbols/toolbox/markdown_renderer.html') === 0) return;
    ...
    var relatedConceptsOverride = {
        ...
        'index.html': [
            { url: '5_Symbols/strategy/motivation.html', title: 'Motivation & ICP', emoji: '🔥' },
        ...
        '5_Symbols/strategy/motivation.html': [
        ...
        '5_Symbols/hypotheses/hyp-h34.html': [
            { url: '5_Symbols/growth/courses-production-collaborative-video.html', title: 'Courses Production SOP', emoji: '🎬' },
            { url: '5_Symbols/hypotheses/hyp-h29.html', title: 'H29 Listen', emoji: '👂' },

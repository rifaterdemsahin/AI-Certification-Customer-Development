...
- `5_Symbols/strategy/` — standalone strategy/growth pages: `raise.html` (R.A.I.S.E. starting point), `motivation.html`, `focus.html`, `target-audience.html`, `risk-analysis.html`, `requirements.html`, `business-plan-summary.html`, `competitive-analysis.html`, `evidence-map.html`, `single-founder-bandwidth.html`, `why-certification.html`, `moat.html`, `maot.html`.

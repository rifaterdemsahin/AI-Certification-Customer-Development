...
- `5_Symbols/product/` — `idea.html`, `partners.html`, `pitch-deck.html`, `vc-deck.html`, `self-assessment.html`, `discovery-journey.html`, `exam-prep-product.html`, `exam-performance-evidence.html`, `dictionary.html`.

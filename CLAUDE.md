...
- `5_Symbols/strategy/` — standalone strategy/growth pages: `raise.html` (R.A.I.S.E. starting point), `motivation.html`, `focus.html`, `target-audience.html`, `risk-analysis.html`, `requirements.html`, `business-plan-summary.html`, `competitive-analysis.html`, `evidence-map.html`, `signal-versus-noise.html`, `single-founder-bandwidth.html`, `why-certification.html`, `moat.html`, `maot.html`.
...
- `5_Symbols/product/` — `idea.html`, `partners.html`, `pitch-deck.html`, `vc-deck.html`, `vc-feedback.html`, `self-assessment.html`, `discovery-journey.html`, `exam-prep-product.html`, `exam-performance-evidence.html`, `dictionary.html`, `skool-lms-integration.html`, `skool-founding-members.html`.

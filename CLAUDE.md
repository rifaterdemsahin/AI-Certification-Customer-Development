...
- `5_Symbols/hypotheses/` — the full hypothesis tracker dashboard `hypothesis.html`, `hypothesis-connectivity.html`, and `hyp-h1.html` &rarr; `hyp-h29.html` detail pages.
- `5_Symbols/strategy/` — standalone strategy/growth pages: `raise.html` (R.A.I.S.E. starting point), `motivation.html`, `focus.html`, `target-audience.html`, `risk-analysis.html`, `requirements.html`, `business-plan-summary.html`, `competitive-analysis.html`, `evidence-map.html`, `signal-versus-noise.html`, `single-founder-bandwidth.html`, `listen-more-than-you-speak.html`, `why-certification.html`, `moat.html`, `maot.html`.

...
* **Candidate Anonymization & Privacy Guardrail:** Cohort candidate B. (who provided WhatsApp video feedback on burnout, voluntary redundancy, and Anthropic qualification intent) must **ALWAYS** be referenced strictly as **"B."** or **"B"** across all notes, discovery transcripts, reports, hypothesis logs, and UI components to protect personal privacy.

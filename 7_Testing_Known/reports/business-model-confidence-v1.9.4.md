...
Re-derived fresh from each hypothesis's own **Status:** line in `4_Formula/HYPOTHESIS.md`. All 27 hypotheses keep the same status emoji as v1.9.3.
...
| 5 | Orphaned pages | 0 | New page registered in `5_Symbols/toolbox/nav.js` groups + searchIndex; linked from LMS / roadmap / cohort-prep. |
...
Full write-up: `7_Testing_Known/reports/skool-founder-posting-sanity-check-v1.0.md` · site page: `5_Symbols/product/skool-posting-sanity-check.html`.
...
| Earlier | — | — | See prior `7_Testing_Known/reports/business-model-confidence-v*.md` files |

...
```mermaid
flowchart TD
    A["Enterprise Mandate & Incentives<br>(Accenture, IBM, Capgemini)"] -->|Pays Exam Fee + $100 Bonus| B["Consultant (Jamal)<br>High Intent to Pass"]
    B -->|Passive Self-Study Alone| C["Exam Result: 644/1000<br>(FAIL - 76 pts below 720)"]
    C -->|Identifies Critical Need| D["Practice Exam Gap (H27) &<br>Study Deficit"]
    D -->|Solution & Arbitrage| E["$29 Exam Prep Bundle (H21) +<br>Sunday Live Cohort Labs (H8)"]
    E -->|Bridge Gap to 720+| F["Pass Exam & Unlock $100 Bonus<br>Firm Hits Partner Quota (H12)"]

    classDef enterprise fill:#4338ca,stroke:#312e81,color:#fff;
    classDef fail fill:#ef4444,stroke:#b91c1c,color:#fff;
    classDef solution fill:#10b981,stroke:#047857,color:#fff;
    classDef normal fill:#1f2937,stroke:#374151,color:#fff;
...
3. **Synchronize Repository Evidence:**
   - Register Jamal interview in `5_Symbols/cd/archived-interview-transcripts.html`, `5_Symbols/cd/cd-interview-recording.html`, `5_Symbols/cd/cd-interview-pdf.html`, `5_Symbols/product/exam-performance-evidence.html`, `4_Formula/HYPOTHESIS.md`, and `5_Symbols/toolbox/nav.js`.

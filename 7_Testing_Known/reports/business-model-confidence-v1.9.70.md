...
3. `4_Formula/HYPOTHESIS.md` **v1.264.0**.
...
| Broken local links | 0 | Fresh HTML scan: 1 false-positive `$2` in `5_Symbols/toolbox/markdown_renderer.html` template code. No real missing files. |

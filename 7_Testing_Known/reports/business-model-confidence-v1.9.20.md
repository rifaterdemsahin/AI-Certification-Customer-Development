> **Superseded by** [`7_Testing_Known/reports/business-model-confidence-v1.9.21.md`](business-model-confidence-v1.9.21.md). Numbers below are the historical record for this run and are not edited in place.
...
| 5 | Orphaned pages | 0 | New page registered in `5_Symbols/toolbox/nav.js` groups + searchIndex, linked from `hypothesis.html`, `hyp-h1.html`, `hypothesis-connectivity.html`, `index.html`, `latest-pages.html`, `evidence-map.html`, and `signal-versus-noise.html`. |

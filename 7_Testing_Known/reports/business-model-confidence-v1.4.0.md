...
Re-derived fresh from each hypothesis's own **Status:** line in `4_Formula/HYPOTHESIS.md`. Details for H11 and H14 were updated, but no status tier changed since v1.3.0.

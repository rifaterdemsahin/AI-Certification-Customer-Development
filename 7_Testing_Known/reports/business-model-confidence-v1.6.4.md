> **Superseded by [`business-model-confidence-v1.6.5.md`](business-model-confidence-v1.6.5.md) (2026-08-11)** — This version is kept as the historical record.

# Business Model Confidence Report — v1.6.4

**Date:** 2026-08-11
**Produced by:** the `business-model-sanity-check` skill (`.claude/skills/business-model-sanity-check/SKILL.md`)
**What changed vs. v1.6.3:** Created "Tell Us About Your Idea" page (`5_Symbols/product/idea.html`) detailing the elevator pitch, problem solved, differentiators, ideal customer, and opportunity size. Cross-linked it to the Business Plan Summary and registered it in the navigation menu and search index. Overall score remains at 41 (Validation holds at 29.8% [30/100], Site Integrity holds at 67.5% due to −10 uncommitted-work deduction). Will rise to 44 once committed.
...
| Sub-score | v1.6.3 | v1.6.4 | Change |
|---|---|---|---|
...
| # | Finding | v1.6.3 | v1.6.4 | Deduction | Rationale |
|---|---|---|---|---|---|
...
| 3 | 4_Formula/HYPOTHESIS.md table/entry mismatches | 0 | 0 | 0 | All 24 rows match their entries. |
| 4 | Broken local links | 0 | 0 | 0 | Full-repo scan, 0 real broken links |
| 5 | Orphaned pages | 0 | 0 | 0 | Resolved. Tell Us About Your Idea page registered in nav dropdown and search index, and linked from business plan summary. |
...
| v1.5.3 | 2026-08-11 | 43 / 100 (Low-moderate) | Created `7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.3.0.md` with qualitative interview insights, and updated H1, H3, H5, H8, H14, H21 |
| v1.5.2 | 2026-08-11 | 40 / 100 (Low-moderate) | Registered `skills-gap.html` in `5_Symbols/toolbox/nav.js` Strategy dropdown and updated related pages |
...
| v1.5.0 | 2026-08-11 | 40 / 100 (Low-moderate) | Added `7_Testing_Known/reports/exam-prep-market-and-student-behavior-v1.2.0.md` with Sude's interview insights, and updated H5, H8, H20, H21 |

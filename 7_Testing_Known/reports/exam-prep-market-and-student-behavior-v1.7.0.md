...
- This matches the user-supplied indicator that started this research: Capgemini reimbursement policies for cloud certification exams, where certification functions as a credential that raises billable client rates (see `7_Testing_Known/reports/market-validation-argument-v1.0.md`, Section 2).

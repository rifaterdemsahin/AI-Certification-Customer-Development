...
| 5 | Orphaned pages | 0 | `skool-about.html` is registered in `5_Symbols/toolbox/nav.js` groups + searchIndex and inbound-linked from offer, LMS, H5, hub, dictionary, latest-pages |

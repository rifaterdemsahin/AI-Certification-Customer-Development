> **Superseded by** [`business-model-confidence-v1.9.33.md`](business-model-confidence-v1.9.33.md). Numbers below are the historical record for this run.

# Business Model Confidence Report — v1.9.32

**Date:** 2026-08-14  
**Produced by:** the `business-model-sanity-check` skill (`.claude/skills/business-model-sanity-check/SKILL.md`)  
**What changed vs. v1.9.31:** patch re-run, no new check categories. Created the `7_Testing_Known/reports/score-fluctuation-analysis-v1.0.0.md` report explaining the score change dynamics (up to 46, down to 43) due to uncommitted work deductions ($-10$) in Site Integrity. Registered the report in `5_Symbols/toolbox/nav.js` dropdown menu and search index. Bumps version tracker to `v1.91.0` in `4_Formula/HYPOTHESIS.md`. Status tiers unchanged — the new retrospective analysis is not a validation event. Same uncommitted batch, so the $-10$ deduction is kept. Integrity holds 67.5; overall holds **43**.
...
> Hypothesis Validation holds at **32.1/100** (28 hypotheses; no status emoji changes). Site Integrity holds at **67.5/100** (same uncommitted batch). Overall **43**.
...
| Sub-score | v1.9.31 | v1.9.32 (this run) |
|---|---|---|
...
Re-derived from each hypothesis's own **Status:** line. All 28 keep the same leading emoji as v1.9.31. Sum 900 / 28 = **32.14**.
...
| 5 | Orphaned pages | 0 | Fluctuation report is registered in `5_Symbols/toolbox/nav.js` groups + searchIndex |
| 6 | Headline number consistency | 0 | $10,000 / 1,000x / $100,000 / >40% unchanged |
| 7 | Uncommitted work (`git status --porcelain`) | −10 | Same uncommitted batch. Committing this batch will restore Integrity to 77.5. |
...
1. **Commit the open batch** — restores Integrity to 77.5 and the overall score to **46**.
...
- H5 → paid Share Screen / $250–$500 enrollments, not more $0/$1 community joins, keywords config, or a Public/Private toggle.
...
|---|---|---|---|
| **v1.9.32** | 2026-08-14 | **43 / 100** | Re-run after adding Score Fluctuation Analysis; same uncommitted batch keeps score at 43 |
| v1.9.31 | 2026-08-14 | 43 / 100 | Founder confirmed Public; same uncommitted visibility batch; score holds 43 |
| v1.9.30 | 2026-08-14 | 43 / 100 | Skool Visibility (Public vs Private) how-to + H5 Premise 11; uncommitted −10; Integrity 77.5 → 67.5 |
| v1.9.29 | 2026-08-14 | 46 / 100 | Pricing feedback v1.0.0 + discoverability keywords committed; Integrity 67.5 → 77.5 |
| v1.9.28 | 2026-08-14 | 43 / 100 | Live Freemium entitlements + pricing feedback v1.0.0; leftover keywords draft kept −10 |

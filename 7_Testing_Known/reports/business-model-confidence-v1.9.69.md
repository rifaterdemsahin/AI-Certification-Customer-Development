...
`4_Formula/HYPOTHESIS.md` **v1.255.0**.
...
14 × 55 (H1, H2, H3, H4, H5, H10, H23, H24, H27, H28, H29, H30, H31, H32) + 17 × 20 (H7–H9, H11–H22 except H10; plus H25, H33) + 1 × 10 (H6) = 770 + 340 + 10 = **1120 / 32 = 35.0**.
...
| H32 | Priestley five-step path / 300-video fence | 🟡 In Testing | 55 |
| H33 | £100k GBP pure-time pivot | ⚪ Hypothesized/Decided | 20 |
...
| Orphaned pages | 0 scored | Untracked `one-minute-shorts-tasks.html` is prior WIP, not this batch; not wired. H33 pages are in `5_Symbols/toolbox/nav.js` Favorites + Growth + searchIndex. |

...
No hypothesis's own Status line in `4_Formula/HYPOTHESIS.md` changed between v1.0.0 and this
...
| 3 | 4_Formula/HYPOTHESIS.md H3 table/entry mismatch | −5 (fixed in v1.0.0) | 0 — stays fixed, confirmed still correct in the committed file |

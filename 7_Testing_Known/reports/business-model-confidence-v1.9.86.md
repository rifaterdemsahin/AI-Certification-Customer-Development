...
- Orphaned pages: **0** — `slogan.html` is in `5_Symbols/toolbox/nav.js` groups, Favorites, searchIndex, and linked from multiple live pages.
...
- Uncommitted work: **−10** — `git status --porcelain` shows one coherent slogan feature:
  ...
  - Modified (same feature): `5_Symbols/toolbox/nav.js`, `index.html`, `4_Formula/HYPOTHESIS.md`, `CLAUDE.md`, `gemini.md`, `agents.md`, `5_Symbols/strategy/business-overview.html`, BMC + value-proposition, idea, one-pager, skool-about, positive-ai-skills-message, why-certification, face-to-face-core-message, latest-pages, hyp-h1 / hyp-h24 / hyp-h30.

...
| 5 | Orphaned pages | 0 | New page is in `5_Symbols/toolbox/nav.js` Strategy dropdown + searchIndex + hub + inbound links from value-proposition, marketing-tactics, when-to-advertise, focus, dictionary, latest-pages. |

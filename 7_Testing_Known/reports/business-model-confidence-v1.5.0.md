...
Re-derived fresh from each hypothesis's own **Status:** line in `4_Formula/HYPOTHESIS.md`. Added H23.
...
| 7 | Uncommitted work (`git status --porcelain`) | 0 | **−10** | Temporary deduction — active batch of changes (new execution pages, modified 5_Symbols/toolbox/nav.js, index.html, sitemap.xml, tool scripts) is uncommitted. Clears to 0 on commit. |

...
```mermaid
flowchart TD
    A["YouTube / LinkedIn Video Short<br>(60s Roger Rabbit / Dalinea Animation)"] -->|Paranoia Hook + 1% Framing| B["Call to Action:<br>3-Minute Private Assessment Quiz"]
    
    B -->|Click Description Link / QR Code| C["Interactive Self-Assessment<br>(5_Symbols/product/self-assessment.html)"]
    
    C --> D{"Diagnostic Routing Engine<br>(Timeline, Budget, Learning Style)"}
    
    D -->|Budget: $0 / Explorer| E["🟢 Free Sunday Cohort ($0 Peek)<br>Live Screen-Share & Discovery"]
    D -->|Low Budget / Urgent Solo| F["📦 $29 Exam Prep Bundle<br>Memory Cards + Mock Exams (H21)"]
    D -->|Ongoing Flex / Replays| G["💳 $10/mo Skool Membership<br>Vaults, CLI Scripts & Archives"]
    D -->|High Budget / Career Transformation| H["🎓 $250 VIP Share Screen<br>1-1 Presets & FDE Alliance (H30)"]
```
...
4. **Update Repository Indices:** Synchronize `4_Formula/HYPOTHESIS.md` (H2, H4, H5, H10, H21, H24, H28, H29, H30), `5_Symbols/growth/marketing-tactics.html`, `5_Symbols/cd/archived-interview-transcripts.html`, and `5_Symbols/toolbox/nav.js`.

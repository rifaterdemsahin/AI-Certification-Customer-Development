> **Superseded by** [`business-model-confidence-v1.9.27.md`](business-model-confidence-v1.9.27.md).

# Business Model Confidence Report — v1.9.26

**Date:** 2026-08-14  
**Produced by:** the `business-model-sanity-check` skill (`.claude/skills/business-model-sanity-check/SKILL.md`)  
**What changed vs. v1.9.25:** patch re-run, no new check categories. Added `5_Symbols/product/skool-delivery-pilot-offer.html` — Hormozi rewrite of the live Delivery Pilot Skool plans (Standard / Premium / VIP → Peek $0 / Sit In $1 / Share Screen $250/year) so a stranger can preview the Sunday room before buying the live-share seat. New H5 Premise 9. Not a paid-enrollment signal. Status tiers unchanged.
...
> Hypothesis Validation holds at **32.1/100** (28 hypotheses; no status emoji changes). Site Integrity holds at **67.5/100** — same uncommitted batch, now also including the Delivery Pilot Offer page. Does not stack a second −10. Overall remains **43**. Committing the tree restores Integrity to 77.5 and the overall score to **46**.
...
| Sub-score | v1.9.25 | v1.9.26 (this run) |
|---|---|---|
...
Re-derived from each hypothesis's own **Status:** line. All 28 keep the same leading emoji as v1.9.25. Sum 900 / 28 = **32.14**. H5 now has Premise 9 (Skool checkout preview ramp) and cites `product/skool-delivery-pilot-offer.html`. Status tier unchanged — $0 and $1 joins are not paid enrollments.
...
| 3 | 4_Formula/HYPOTHESIS.md table/entry mismatches | 0 | All 28 Summary Table rows match their own Status-line leading emoji |
| 4 | Broken local links | 0 | Fresh scan: 5 `href` hits were all JS template strings (`$2`, `' + link + '`, etc.), not real files. 0 real broken links |
| 5 | Orphaned pages | 0 | `skool-delivery-pilot-offer.html` is registered in `5_Symbols/toolbox/nav.js` groups + searchIndex and inbound-linked |
| 6 | Headline number consistency | 0 | $10,000 / 1,000x / $100,000 / >40% unchanged. $0/$1/$250-year is documented as a checkout experiment, not a replacement of the $10/mo + $250–$500 model |
| 7 | Uncommitted work (`git status --porcelain`) | −10 | Same open batch. This run adds the Delivery Pilot Offer page + hero, H5 Premise 9, and related cites. Does not stack a second −10. Clears once committed. |
...
4. **H5 is still In Testing** — a Peek / Sit In join is not a paid enrollment. To cross: convert a portion of those (or new) signups into a real 20–40-student *paid* Share Screen / $250–$500 count.
...
- H5 → paid Share Screen / $250–$500 enrollments, not more $0/$1 community joins.

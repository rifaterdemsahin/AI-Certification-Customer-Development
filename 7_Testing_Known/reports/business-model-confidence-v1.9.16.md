> **Superseded by** [`7_Testing_Known/reports/business-model-confidence-v1.9.17.md`](business-model-confidence-v1.9.17.md).
...
| 5 | Orphaned pages | 0 | New page is in `5_Symbols/toolbox/nav.js` Business Model dropdown + searchIndex + hub + inbound links from founding-members, calendar, dictionary, quality-gates, H8, latest-pages. |

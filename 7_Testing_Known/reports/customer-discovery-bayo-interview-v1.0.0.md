...
* **Tagged Hypotheses:** H24, H29, H1, H5, H8, H25, H30

| Discovery Dimension | Verbatim / Captured Evidence | Practitioner & Business Reality |
| :--- | :--- | :--- |
| **1. Emotional State & Headspace (H24)** | *"I'm struggling with the work situation... tired all the time and stressed out... too many irons in the fire"* | High stress depletes cognitive bandwidth. Educational marketing must acknowledge cognitive limits and avoid adding guilt. |
| **2. Qualification Intent (H1 / H25)** | *"although I'm definitely going to be doing the Anthropic qualification, but I'm just trying to find space in my head"* | AI credentials are seen as essential career assets, not discarded in crisis, but deferred until mental bandwidth clears. |
| **3. Career Transition / Redundancy (H30)** | *"I've signed up for the voluntary exit, so I'm going to leave clean... end of next month"* | Corporate departures create the exact trigger moment to enter contractor pipelines and earn £500–£1,000/day. |
| **4. Asynchronous Workaround (H5 / H8)** | *"I will catch up with the videos... personal apologies that I've not been able to make it to the class"* | Live cohorts need robust, easy-to-access video libraries and modular catch-up materials so absent members stay engaged. |
| **5. Psychological Safety (H29)** | Candidate proactively records a personal video apology acknowledging founder effort. | Founder stewardship and active listening create an environment where members stay connected through life pivots. |
...
### D. Architectural Requirement for H5 & H8 (Async Replays & Flexible Return Loops)
* **Empirical Grounding:** Rigid synchronous attendance penalizes members undergoing life friction. Delivery Pilot must maintain crystal-clear video archives, 5-10-5 summaries, and open-door re-entry policies for Sunday sessions.

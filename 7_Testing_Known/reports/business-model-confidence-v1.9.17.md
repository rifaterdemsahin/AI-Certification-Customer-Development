> **Superseded by** [`7_Testing_Known/reports/business-model-confidence-v1.9.18.md`](business-model-confidence-v1.9.18.md).
...
| 3 | 4_Formula/HYPOTHESIS.md table/entry mismatches | 0 | All 27 Summary Table rows match |
...
| 5 | Orphaned pages | 0 | New page is in `5_Symbols/toolbox/nav.js` Business Model dropdown + searchIndex + hub + inbound links from founding-members, 10-true-regulars, LMS, posting sanity check, dictionary, H5/H8/H20, latest-pages. |

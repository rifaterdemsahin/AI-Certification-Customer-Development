...
```mermaid
flowchart TD
    A["Curse of Knowledge Insight<br>(Marianna Feedback)"] --> B["1. Associate Foundation Ramp<br>(H25 / H1 / H8)"]
    A --> C["2. Sub-60s Glossary Shorts<br>(H2 / H10)"]
    A --> D["3. Psychological Empowerment<br>(H24 / H29)"]
    
    B --> E["Mass Market Top-of-Funnel<br>(High YouTube Volume)"]
    C --> F["High Retention & Virality<br>(>40% Watch-Through)"]
    D --> G["Community Trust & Conversion<br>(Skool Free &rarr; VIP)"]
```
...
4. **Update `4_Formula/HYPOTHESIS.md` and `5_Symbols/toolbox/nav.js`:** Register report, bump version, and link across H2, H10, H24, H25, H29, H30.

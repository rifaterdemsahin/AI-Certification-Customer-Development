# Business Model Confidence Report — v1.9.21

> [!IMPORTANT]
> This version has been superseded by [v1.9.22](file:///Users/rifaterdemsahin/projects/AI-Certification-Customer-Development/7_Testing_Known/reports/business-model-confidence-v1.9.22.md).
> See [the updated report on live page](http://localhost:8000/markdown_renderer.html?src=7_Testing_Known/reports/business-model-confidence-v1.9.22.md).

**Date:** 2026-08-14  
**Produced by:** the `business-model-sanity-check` skill (`.claude/skills/business-model-sanity-check/SKILL.md`)  
**What changed vs. v1.9.20:** patch re-run, no new check categories. Incorporated Perplexity market-feedback sanity check (`7_Testing_Known/reports/raise-validation-perplexity-v1.0.0.md`) validating the R.A.I.S.E. framing and founder origin story, and refined H1's conclusion to reflect that certifications are complementary to, not substitutes for, demonstrable skills and act as filters/screens. Updated H1's Source list, Conclusion, and Status, and updated `5_Symbols/strategy/raise.html` with a Market Validation and Nuance section.
...
> Hypothesis Validation holds at **32.1/100** (28 hypotheses; no status emoji changes). Site Integrity holds at **67.5/100** — same uncommitted batch (10-true-regulars + golden-rules + listen/cocreate + H5 named-pair + H1 isolation page + Perplexity R.A.I.S.E. validation). Does not stack a second −10. Overall remains **43**. Committing the tree restores Integrity to 77.5 and the overall score to **46**.
...
| Sub-score | v1.9.20 | v1.9.21 (this run) |
|---|---|---|
...
Re-derived from each hypothesis's own **Status:** line. All 28 keep the same leading emoji as v1.9.20. Sum 900 / 28 = **32.14**.
...
| 5 | Orphaned pages | 0 | All pages registered in `5_Symbols/toolbox/nav.js` groups and search index. |
| 6 | Headline number consistency | 0 | $10,000 / 1,000x / $100,000 / >40% unchanged. |
| 7 | Uncommitted work (`git status --porcelain`) | −10 | Same open batch of changes. This run adds `7_Testing_Known/reports/raise-validation-perplexity-v1.0.0.md` + edits to `raise.html`, `hyp-h1.html`, `hypothesis.html`, `evidence-map.html`, `latest-pages.html`, and `5_Symbols/toolbox/nav.js`. Does not stack a second −10. Clears once committed. |

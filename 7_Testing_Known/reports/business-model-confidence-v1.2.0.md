...
| 3 | 4_Formula/HYPOTHESIS.md table/entry mismatches | 0 | 0 — all table rows match their entries exactly. |
...
| 6 | Orphaned pages | 0 | 0 — all pages referenced correctly inside 5_Symbols/toolbox/nav.js. |
